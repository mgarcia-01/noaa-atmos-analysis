...
tmEvent <- repdata[which(is.na(repdata$BGN_DATE) == FALSE & is.na(repdata$END_DATE) == FALSE),]
tmEvent <- aggregate(repdata$FATALITIES, list("BGN_DATE","END_DATE"), sum)      # repdata$BGN_DATE
