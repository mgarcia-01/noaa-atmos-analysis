...
#lines(tmEventFtlInj$BGN_DATE,log(tmEventFtlInj$FATALITIES), col = "red",type = "p")
  ...
  par(mfrow=c(2,2))
  #par(mfcol=c(2,1))
  plot(tmEventAg$BGN_DATE,  (tmEventAg$FATALITIES), type = "p", col = "dodger blue",pch = 20 ,xlab = "Event Date", ylab = "Fatalities")
   plot(tmEventFtlInj$BGN_DATE, log(tmEventFtlInj$INJURIES), col = "green", type = "p",pch = 20
       , xlab = "Event Date", ylab = "Qty of People")
      lines(tmEventFtlInj$BGN_DATE,log(tmEventFtlInj$FATALITIES), col = "red",type = "p", pch = 20)
  plot(tmEventInj$BGN_DATE,  (tmEventInj$INJURIES), type = "p", col = "dodger blue",pch = 20, xlab = "Event Date", ylab = "Injuries")
...
plot(tmSeriesAg$MOYR, tmSeriesAg$INJURIES, col = "green", type = "p",pch = 20
       , xlab = "Event Date", ylab = "Qty of People")
 lines(tmSeriesAg$MOYR,tmSeriesAg$FATALITIES, col = "red",type = "p", pch = 20)
